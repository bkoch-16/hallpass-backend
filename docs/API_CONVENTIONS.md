...
- **403** — an authenticated user lacking a required association. Example: `requireSchoolMembership` when the user has no school ("User is not associated with a school").
